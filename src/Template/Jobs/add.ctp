...
<div class="card p-3 rounded border shadow-sm mb-2">
	...
	<fieldset>
		<?php
			...
			echo $this->Form->control('parent_id', ["label" => "Related, Parent Job", "readonly" => ( isset($addToParent) ? "true" : "false" ), "options" => $parentJobsArr, 'help' => 'If this job is part of a larger job, select the "parent" job here.']);
		?><div style="border-bottom: 1px dashed #ccc;" class="mt-4 mb-2"><h5>Job Dates</h5></div><?php
			...
			echo $this->Form->control('time_string', ["label" => "Shift Time(s)", "help" => "Freeform times for the job. Limit to 250 characters."]);
